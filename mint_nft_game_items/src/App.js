            ...
            {data.allLips.map((item, index) => {
              return (
                <s.Container key={index} style={{ padding: "15px" }}>
                  ...
                  <s.SpacerXSmall />
                  <s.Container>
                    <s.TextDescription>ID  <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>: {item.id}</s.TextDescription>
                    <s.TextDescription>DNA <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>   : {item.dna}</s.TextDescription>
                    <s.TextDescription>LEVEL <span>&nbsp;&nbsp;</span> : {item.level}</s.TextDescription>
                    <s.TextDescription>NAME  <span>&nbsp;&nbsp;&nbsp;</span>  : {item.name}</s.TextDescription>
